...
module('Integration | Component | balance-row', function (hooks) {
  ...
  test('renders initials, name, and an "owed" amount when friend owes you', async function (assert) {
    ...
    assert.dom('.balance-row-amount').hasClass('balance-row-amount--owed');
    assert.dom('.balance-row-amount').includesText('USD 42.00');
    assert.dom('.balance-row-amount').includesText('owes you');
  });

  test('renders an "owe" amount label when you owe the friend', async function (assert) {
    this.friend = { id: 3, firstName: 'Jane', lastName: 'Doe' };
    ...
    assert.dom('.balance-row-amount').hasClass('balance-row-amount--owe');
    assert.dom('.balance-row-amount').includesText('you owe');
    assert.dom('.balance-row-amount').includesText('USD 42.00');
  });
